...
- Loads the HAAR model to perform face detection task (the output size needs to be (244*244) pixels for the FaceNet model to work correctly
'''
def extract_face(image_path, required_size=(244, 244)):
...
'''
def load_faces(dir_name, required_size=(244, 244)):
    faces = []
...
'''
def load_dataset(parent_dir_name, required_size=(244, 244)):
    X, y = [], []
